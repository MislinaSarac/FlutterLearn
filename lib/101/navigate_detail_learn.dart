...
class NavigateDetailLearnDart extends StatefulWidget {
  const NavigateDetailLearnDart({Key? key, this.isOkey = false})
      : super(key: key);
  final bool isOkey;
  @override
      ...
      body: Center(
        child: ElevatedButton.icon(
            ...
            icon: Icon(Icons.check,
                color: widget.isOkey ? Colors.pink : Colors.green),
            label: widget.isOkey ? const Text('Pink') : const Text('Green')),
      ),
    );
  }
}
